...
class AppPreferences {
  ...
  String? getString(String key) => _sharedPreferences?.getString(key) ?? _values[key] as String?;
  bool? getBool(String key) => _sharedPreferences?.getBool(key) ?? _values[key] as bool?;
  double? getDouble(String key) => _sharedPreferences?.getDouble(key) ?? (_values[key] as num?)?.toDouble();
  ...
  Future<bool> setString(String key, String value) => _set(key, value, () => _sharedPreferences!.setString(key, value));
  Future<bool> setBool(String key, bool value) => _set(key, value, () => _sharedPreferences!.setBool(key, value));
  Future<bool> setDouble(String key, double value) => _set(key, value, () => _sharedPreferences!.setDouble(key, value));
  Future<bool> setStringList(String key, List<String> value) => _set(key, value, () => _sharedPreferences!.setStringList(key, value));
  ...
  Future<bool> _set(String key, dynamic value, Future<bool> Function() nativeWrite) async {
  ...
  Future<void> _flush() {
    _writeQueue = _writeQueue.then((_) async {
      ...
      await temp.writeAsString(const JsonEncoder.withIndent('  ').convert(_values));
